#ifndef __TREELIB_BINARY_TREE_PRETTY_PRINT_GENERIC_VALUE_DEFINITION_HEADER__
#define __TREELIB_BINARY_TREE_PRETTY_PRINT_GENERIC_VALUE_DEFINITION_HEADER__
#include <stdint.h>
