...
static void test_single_push(void **state) {
    (void) state;
    uint8_t      status = 0;
    TestData     td1 = {1, 3.14};
    GenericStack stack;
...
static void test_top_element(void **state) {
    (void) state;
    GenericStack stack;
    TestData td1    = {1, 3.14};
...
static void test_stack_pop_is_valid(void **state) {
    (void)state;
    GenericStack stack;
    TestData td1 = {1, 3.14};
    TestData td2 = {2, 6.28};
...
static void test_stack_pop_after_empty(void **state) {
    (void)state;
    GenericStack stack;
    TestData td1 = {1, 3.14};
...
static void test_stack_destruction_valid(void **state) {
    (void)state;
    GenericStack stack;
...
static void test_stack_fuzz(void **state) {
    (void)state;
...
int run_all_stack_tests() {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_single_push),
        cmocka_unit_test(test_top_element),
        cmocka_unit_test(test_stack_dynamic_growth),
        cmocka_unit_test(test_stack_pop_is_valid),
        cmocka_unit_test(test_stack_pop_after_empty),
        cmocka_unit_test(test_stack_destruction_valid),
        cmocka_unit_test(test_stack_fuzz)
    };
