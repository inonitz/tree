...
typedef enum __avl_test_random_operation_type {
    ...
    CTEST_AVL_OPER_COPY_OP,
    CTEST_AVL_OPER_MAX_OP
} CTestOperationType;


typedef enum __avl_test_logging_operation_option_type {
    CTEST_LOG_OPTION_DIRECTLY_TO_FILE      = 0, 
    CTEST_LOG_OPTION_REDIRECT_CACHE_BUFFER = 1, 
    CTEST_LOG_OPTION_CANCEL_OPERATION      = 2,
    CTEST_LOG_OPTION_GLOBAL_DEFAULT        = 3,
    CTEST_LOG_OPTION_MAX                   = 4
} CTestLoggingOption_t;
